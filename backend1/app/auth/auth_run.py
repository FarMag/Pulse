...
from backend1.app.auth.routes import (register_bp, login_bp, refresh_token_bp, check_token_bp,
                                      add_full_information_user_bp, get_user_data_bp, get_user_data_and_age_bp, update_user_information_bp, update_user_xp_bp,
                                      check_user_authorization_bp, add_user_note_bp, welcome_bp)
...
app.register_blueprint(get_user_data_and_age_bp, url_prefix='/api')
...
app.register_blueprint(check_user_authorization_bp, url_prefix='/api')
app.register_blueprint(add_user_note_bp, url_prefix='/api')
